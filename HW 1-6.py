...
print("Переменная d, при значении переменной a - %d, переменной b - %d и пременной с - %d равна %.2f"
...
print("При значении переменной a2 - %d, переменной b2 - %d и переменной с2 - %d, переменная d2 равна %.2f "
